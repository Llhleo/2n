...
await build({entryPoints:{app:'app.mjs',study:'study.mjs','proof-renderer':'proof-renderer.mjs'},bundle:true,minify:true,format:'esm',outdir:'public',target:['safari16','chrome100'],external:['./svg-renderer.js','./terrain.js','./proof-renderer.js'],legalComments:'linked'});
